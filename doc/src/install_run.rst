...
install anything you can use our `FEMhub Online Lab <http://nb.femhub.org/>`.

Binary
------

You can view a list of the binaries of all versions`here <htt://femhub.org/pub/`. From there you can download the
version you want.
...
You can get the tarball of sources here `here <htt://femhub.org/pub/`. 
...
If you download the sources, please read below on how to build FEMhub and work around common issues: 
   ...
   1. Make sure you have the dependencies and 2GB free disk space.
     ...
     Microsoft Windows: install cygwin using the setup.exe and in that choose to
...
If you want, you can also download a binary from `here <htt://femhub.org/pub/`, however, if it doesn't work for you, compile from source, that should always work.
